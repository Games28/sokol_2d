...
*/
static const uint8_t sgp_vs_source_glsl430[290] = {
...
static inline const sg_shader_desc* sgp_program_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)sgp_vs_source_glsl430;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)sgp_fs_source_glsl430;
